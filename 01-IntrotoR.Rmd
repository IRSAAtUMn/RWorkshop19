...
Next, let's look at the `bechdel` data in the `fivethirtyeight` package. This data was used in the fivethirtyeight.com's article ["The Dollar-And-Cents Case Against Hollywood's Exclusion of Women"](http://fivethirtyeight.com/features/the-dollar-and-cents-case-against-hollywoods-exclusion-of-women/) which analyzes movies that do/don't pass the **Bechdel test**. 
